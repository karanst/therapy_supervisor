                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text("Patient Detail",style: TextStyle(color: Theme.of(context).colorScheme.fontColor,fontSize: 18,fontWeight: FontWeight.w600),),
                       const SizedBox(height: 10,),
                      Container(
                        width: MediaQuery.of(context).size.width,
                        child: Column(
                      ...
                      const  SizedBox(height: 12,),
                       Text("Therapy Period",style: TextStyle(color: Theme.of(context).colorScheme.fontColor,fontSize: 18,fontWeight: FontWeight.w600),),
                      Container(
